                ...
                <input value={email} onChange={e=>setEmail(e.target.value)}  type="email" className=' my-input' placeholder="Email or Phone" id="username"/>
                    ...
                    <input value={password} onChange={e=>setPassword(e.target.value)}type="password" className=' my-input' placeholder="Password" id="password"/>
                        ...
                        <div className="social mb-5">
                            ...
                            }}className="go" style={{color:"black", backgroundColor:"white",fontWeight:"bold"}}><i className="fab fa-google"></i><img style={{marginRight:"1vw",width:"25px",display:"inline-block"}}src={googlelogo}></img>Google</div>
                        </div>
                        <label onClick={e=>{
                            e.preventDefault();
                            navigate("/signup");
