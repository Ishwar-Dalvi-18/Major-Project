...
function CustomerInfo() {
    ...
    const  n_info = useContext(customerNavigationContext).info;
    const  n_setInfo= useContext(customerNavigationContext).setInfo;
    useEffect(() => {
        n_setInfo({currentpage:"profile"})
    ...
    return (
        ...
        <div style={{
            ...
            <div ref={master_ref} >
                ...
                <div className='customerinfo-main-container'>

                    <div className='customerinfo-cover'>

                    </div>
                    <div className='customerinfo-content'>
                        <div className='customerinfo-content-firsthalf'>
                            <div style={{
                                display: "flex",
                            ...
                            <div className="customerinfo-content-name">
                                <p>{info.username}</p>
                            </div>
                            <div className="customerinfo-content-email">
                                <p>{info.email}</p>
                            </div>
                        </div>
                        <div className='customerinfo-content-secondhalf'>
                            <div className='first'>
                                <div className='m-1'>
